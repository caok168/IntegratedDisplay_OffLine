...
namespace MyComponets.DBUtility
{
    ...
    internal static class OracleConnectionHelperGJ
    {
        /// <summary>
        /// 返回数据库的连接字符串
        /// </summary>
    ...
    /// </summary>
    public abstract class OracleHelperGJ
    {
        // Read the connection strings from the configuration file
        public static readonly string ConnectionStringOracle = OracleConnectionHelperGJ.GetConnection();
    ...
    /// 数据库操作方法与属性
    /// </summary>
    public abstract class OracleDataBaseGJ
    {
        //获取Web.Config数据库连接字符串
        private readonly string OracleConnectionString = OracleConnectionHelperGJ.GetConnection();
    ...
    /// All rights reserved
    /// </summary>
    public abstract class OracleDbHelperGJ
    {
        private static readonly string connectionString = OracleConnectionHelperGJ.GetConnection();

        public static readonly string conString = connectionString;

        public OracleDbHelperGJ() { }
        ...
        public static int GetMaxID(string FieldName, string TableName)
        {
            ...
            object obj = OracleDbHelperGJ.GetSingle(strOracle);
            if (obj == null)
            {
                return 1;
            }
        ...
        {
            object obj = OracleDbHelperGJ.GetSingle(strOracle, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
        ...
        public static string GetSequencesID(string seqName, string seqFormat)
        {
            ...
            object obj = OracleDbHelperGJ.GetSingle(strOra);
            if (obj == null)
            {
                return string.Empty;
            }
